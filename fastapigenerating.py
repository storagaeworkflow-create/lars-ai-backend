...
# backend/fastapigenerating.py
from fastapi import FastAPI, Request
from fastapi.middleware.cors import CORSMiddleware
import textwrap
from utils import safe_print, fetch_recent_trends, generate_response_with_ollama  # adjust imports if needed

app = FastAPI(title="LARS AI Assistant Backend")
...
async def generate(request: Request):
    ...
    try:
        ...
        safe_print(f"DEBUG: Received payload: {data}")  # debug
        ...
        safe_print(f"DEBUG: Recent trends: {recent_trends}")
        ...
        safe_print(f"DEBUG: Generated report length: {len(report)} characters")
